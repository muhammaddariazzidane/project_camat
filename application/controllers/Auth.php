...
class Auth extends CI_Controller
{
  public function index()
  {
    ...
    $this->form_validation->set_rules('email', 'Email', 'required|valid_email|max_length[40]', ['required' => 'Email harus diisi', 'valid_email' => 'Email tidak valid', 'max_length' => 'Email maksimal 40 karakter']);
